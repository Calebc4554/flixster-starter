...
const App = () => {
	...
	const options = {
		...
		headers: {
			...
			Authorization:
				"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI4OGYxOGUzOGRmYTc0YzFiZjBlZjU1MGJiZjk0M2U4MCIsIm5iZiI6MTc0OTUxMTY2Mi43MzUwMDAxLCJzdWIiOiI2ODQ3NmRlZWZjNjMwMGQ3YjMzZmNiZmUiLCJzY29wZXMiOlsiYXBpX3JlYWQiXSwidmVyc2lvbiI6MX0.ICuI9VPqBEqEyv2k-Wv5pPDKj0iGUGbIMFsI98cropc",
		},
	};
	...
	return (
		<main className="App">
			<header>
				...
				<section className="appArticle">
					<input
						...
						placeholder="Search"
					/>
					<button type="button" className="appButtons" onClick={handleSearchClick}>
						{" "}
						Search
					</button>
					<button type="button" className="appButtons" onClick={handleClearClick}>
						{" "}
						Clear{" "}
					</button>
					<select
			...
			<footer className="appFooter">
				<section>
					<button type="button" className="appButtons" onClick={loadMore}>
						Load More
					</button>
				</section>
			</footer>
